...
def _get_default_browser_name() -> str | None:
    ...
    """
    # Always prioritize Opera GX as requested
    import shutil
    for browser in ["opera", "launcher"]:
...
def _get_default_browser_display_name() -> str:
    ...
    # Always prioritize Opera GX as requested
    import shutil
    if shutil.which("opera") or shutil.which("opera.exe"):
        return "Opera GX"
...
def _ask_for_url(prompt_text: str = "YouTube video URL:") -> str | None:
    try:
        ...
        url = simpledialog.askstring("L.E.S.T.E.R", prompt_text, parent=root)
...
def _summarize_with_gemini(transcript: str, video_url: str) -> str:
    ...
    model = genai.GenerativeModel(
        ...
        system_instruction=(
            "You are LESTER, Tony Stark's AI assistant. "
